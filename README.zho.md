...
[ENGLISH](README.md) | [FRENCH](README.fra.md) | [CHINESE](README.zho.md) | [Add a language](how-to-add-a-language.md)
...
源代码支持行号显示和语法着色。 
Markdown 则使用 VS Code 的预览格式渲染——绝大多数 Markdown 扩展都支持打印
